# MASTER PROMPT: LIQUID DIMENSIONS - IRIDESCENT

**Objective:** Create a high-fidelity visual component simulating fluid dynamics and glassmorphism with a Holographic, Modern aesthetic.

## 1. Visual Aesthetics ("The Vibe")

- **Theme:** "IRIDESCENT." Oil slick colors on chrome.
- **Palette:**
  - **Background:** Dark Grey
  - **Accent:** Rainbow/Pearlescent
  - **Highlights:** Chrome
- **Motion:** Goopy, stretching, morphing blobs
...
- **Mouse:** Mouse pushes and pulls the liquid.
- **Scroll:** Change in viscosity or gravity.
