# MASTER PROMPT: QUANTUM FIELD - CRIMSON

**Objective:** Create a high-fidelity visual component simulating subatomic particle probability with a Unstable, Dangerous aesthetic.

## 1. Visual Aesthetics ("The Vibe")

- **Theme:** "CRIMSON." High energy particle collision.
- **Palette:**
  - **Background:** Dark Maroon
  - **Accent:** Lava Red (#EF4444)
  - **Highlights:** Orange Plasma
- **Motion:** Jittery, high-frequency vibration
...
- **Mouse:** Mouse acts as an observer, collapsing wave functions (particles freeze or cluster).
- **Scroll:** Zoom into the subatomic realm.
