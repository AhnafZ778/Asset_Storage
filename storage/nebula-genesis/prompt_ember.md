# MASTER PROMPT: NEBULA GENESIS - EMBER

**Objective:** Create a high-fidelity visual component simulating star formation and cosmic clouds with a Hot, Volatile aesthetic.

## 1. Visual Aesthetics ("The Vibe")

- **Theme:** "EMBER." Dying star remnants.
- **Palette:**
  - **Background:** Dark Red
  - **Accent:** Orange (#FB923C)
  - **Highlights:** Yellow
- **Motion:** Swirling gas, explosive births
...
- **Mouse:** Mouse rotates the cosmic view.
- **Scroll:** Travel through the nebula.
