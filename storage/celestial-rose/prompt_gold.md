# MASTER PROMPT: CELESTIAL ROSE - GOLD

**Objective:** Create a high-fidelity visual component simulating sacred geometry and light beams with a Royal, Luxurious aesthetic.

## 1. Visual Aesthetics ("The Vibe")

- **Theme:** "GOLD." Solid gold geometry.
- **Palette:**
  - **Background:** Rich Brown/Black
  - **Accent:** Golden Yellow (#FBBF24)
  - **Highlights:** Metallic Shine
- **Motion:** Rotating mandala, falling petals
...
- **Mouse:** Mouse rotates the perspective of the rose.
- **Scroll:** Rose blooms/expands.
